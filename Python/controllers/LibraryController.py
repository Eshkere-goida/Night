...
class LibraryController:
    ...
    def _update_book(self):
        ...
        old_title, old_author, old_year = book[1], book[2], book[3]
    ...
    def _delete_book(self):
        ...
        try:
            ...
            confirm = input(f"  Вы уверены, что хотите удалить '{book[1]}'? (y/n): ")
            if confirm.lower() == 'y':
    ...
    def _find_book_by_id(self):
        ...
        book = self.service.find_book_by_id(book_id)
        if book:
            print(f"  Найдено: ID {book[0]}: '{book[1]}' ({book[2]}, {book[3]}г.)")
        else:
